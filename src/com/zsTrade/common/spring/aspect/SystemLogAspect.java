package com.zsTrade.common.spring.aspect;
...
import com.zsTrade.common.spring.annotation.Log;
import com.zsTrade.common.utils.IPUtils;
import com.zsTrade.web.sys.model.SysLog;
import com.zsTrade.web.sys.service.SysLogService;
...
public class SystemLogAspect {
	...
	@Pointcut("@annotation(com.zsTrade.common.spring.annotation.Log)")
	public void accessAspect() {
	}
	
	@Pointcut("execution(* com.zsTrade.web..*Service.*(..))")
