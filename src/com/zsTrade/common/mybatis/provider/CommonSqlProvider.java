package com.zsTrade.common.mybatis.provider;
...
import com.zsTrade.common.mybatis.EntityHelper;
...
public class CommonSqlProvider extends BaseProvider{
	...
	public String findEntityListByDataScope(final Map<String, Object> params){
		...
		return new SQL(){{
            ...
            com.zsTrade.common.mybatis.EntityHelper.EntityTable entityTable = EntityHelper.getEntityTable(entityClass);
            SELECT(com.zsTrade.common.mybatis.EntityHelper.getAllColumns(entityClass));
