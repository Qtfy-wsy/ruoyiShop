...
package com.zsTrade.web.sys.model;
...
public class SysUser extends BaseEntity {
	...
	private String yue;
	public String getYue() {return this.getString("yue");}
	public void setYue(String yue) {this.set("yue",yue);}

	private String jifen;
	public String getJifen() {return this.getString("jifen");}
	public void setJifen(String jifen) {this.set("jifen",jifen);}
    ...
    public String getLicenseCode() {
		return this.getString("licenseCode");
    }
   
    public void setLicenseCode(String licenseCode) {
		this.set("licenseCode", licenseCode);
    }
