<template>
	<view class="address-manage rf-row-wrapper">
		...
		<view class="row b-b">
    			...
    			<input placeholder="请选择地址" disabled="true" :value="addressData.province + ' ' + addressData.city + ' ' + addressData.region" @click="lotusAddressData.visible = true" class="input">
