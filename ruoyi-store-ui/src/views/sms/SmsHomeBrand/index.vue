...
<script>
  ...
  import {listBrand as fetchBrandList} from '@/api/goods/brand';
import { listSmsHomeBrand, getSmsHomeBrand, delSmsHomeBrand, addSmsHomeBrand, updateSmsHomeBrand, exportSmsHomeBrand,updateRecommendStatus,updateHomeBrandSort } from "@/api/sms/SmsHomeBrand";
  ...
  export default {
    ...
    methods: {
      ...
      handleDialogSizeChange(val) {
        this.dialogData.listQuery.pageNum = 0;
      ...
      handleSelectDialogConfirm(){
        ...
        this.$confirm('使用要进行添加操作?', '提示', {
          ...
          addSmsHomeBrand(selectBrands).then(response=>{
      ...
      getList() {
        ...
        listSmsHomeBrand(this.listQuery).then(response => {
      ...
      deleteBrand(ids){
        this.$confirm('是否要删除该推荐?', '提示', {
          ...
          let params=new URLSearchParams();
          params.append("ids",ids);
          delSmsHomeBrand(ids).then(response=>{
            this.getList();
            this.$message({
              type: 'success',
              message: '删成功!'
      ...
      getDialogList(){
      this.dialogData.listQuery.status=1;
